    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try{
            ...
            if(session != null){
                ...
                if(cart != null){
                    //3. Cust gets item
                    Map<String, tblItemDTO> items = cart.getItem();
                    if(items != null){
                        //Cust picks all removed item up
                        ...
                        }//end if removed items has selected
                    }//end if item is ecisted
                }//end if cart is existed
            }//end if session is existed
            
        }
        finally{
            //call view cart funtion again
